            ...
            >
              <Card
                sx={{
                  ...
                  height: "100%", // ✅ هاد بخلي الكارد ياخذ كل ارتفاع الـ Box الأب
                }}
              >
                {isMyProfile && (
                  <IconButton
                ...
                {p.coverImage && (
                  <Box
                    ...
                    sx={{
                      width: "100%",
                      height: 220, // ✅ ارتفاع ثابت (بدون responsive)
                      objectFit: "cover", // ✅ بقص الصورة عشان تملأ المساحة
                      display: "block",
                      flexShrink: 0, // ✅ ما يصغر
                    }}
                  />
                )}
