    ...
    >
      ...
      <Paper
        ...
        sx={{
          ...
          borderRightColor:
            theme.palette.mode === "dark" ? "#424242" : "#e2e8f0",
          display: "flex",
          ...
          {menuItems.map((item) => (
            <Tab
              ...
              sx={{
                ...
                "&.Mui-selected": {
                  bgcolor:
                    theme.palette.mode === "dark" ? "#323232ff" : "#f0f9ff",
                  color: "#0284c7",
                  fontWeight: "bold",
                },
                "& .MuiSvgIcon-root": {
                  marginRight: isMobile ? 0 : "12px !important",
                  fontSize: 24,
                },
              }}
            />
      ...
      >
        <Box mb={4}>
          <Typography
            ...
            fontWeight="bold"
            sx={{
              color: theme.palette.mode === "dark" ? "#f0f9ff" : "#1e293b",
            }}
          >
            Admin Dashboard
          </Typography>
        ...
        <Box>
          ...
          {currentTab === 2 && (
            <ReportsTap highlightedReportId={reportIdParam} />
          )}
        </Box>
      </Box>
    </Box>
