...
const ProjectDetails = () => {
    ...
    return (
        <Box sx={{ mt: 4, mb: 6 }}>
            ...
            <Container maxWidth="lg" sx={{ mb: 6 }}>
                <Box sx={{ display: "flex", gap: 4, alignItems: "flex-start" }}>
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                            <Typography variant="h6" sx={{ fontWeight: "bold", mb: 3, fontSize: "1.2rem" }}>
                                Service Details
                            </Typography>
                            ...
                            >
                                ...
                                <Typography variant="body2" sx={{ fontWeight: "medium" }}>
                                    {project.deliveryTimeInDays || "N/A"} {project.deliveryTimeInDays ? "days" : ""}
                                </Typography>
                            </Box>
            ...
            <Container maxWidth="lg">
                {/* Project Title */}
                <Typography variant="h3" sx={{ fontWeight: "bold", mb: 3, fontSize: { xs: "1.8rem", md: "2.2rem" } }}>
                    {project.title}
                </Typography>
                ...
                <Box sx={{ display: "flex", alignItems: "center", mb: 4 }}>
                    ...
                    >
                        {!project.profilePicture && (project.userName?.[0]?.toUpperCase() || "U")}
                    </Avatar>
                    <Box>
                        <Typography variant="body1" sx={{ fontWeight: "medium", fontSize: "1.05rem" }}>
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <Typography variant="body1" color="text.secondary" sx={{ fontSize: "1.02rem", lineHeight: 1.8 }}>
                            ...
                            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1.5 }}>
                                {project.tags.map((tag, i) => (
                                    <Chip
                                        key={i}
                                        label={tag}
                                        sx={{ bgcolor: "rgb(0 0 0 / 6%)", fontSize: "0.95rem", py: "22px" }}
                                    />
                                ))}
                            </Box>
                        </Box>
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    {project.filePath && project.filePath.trim() !== "" ? (
                        ...
                        >
                            ...
                            <Box sx={{ flexGrow: 1 }}>
                                <Typography variant="body1" sx={{ fontWeight: "medium", mb: 0.5, fontSize: "1.05rem" }}>
                                    Project Attachment
                                </Typography>
                ...
                {/* Reviews Section */}
                <Box>
                    <Typography variant="h5" sx={{ fontWeight: "bold", mb: 3, fontSize: "1.3rem" }}>
                        Reviews
                    </Typography>
                    ...
                    >
                        ...
                        {isReviewDisabled ? (
                            <DisabledCustomButton fullWidth>Submit Review</DisabledCustomButton>
                        ) : (
